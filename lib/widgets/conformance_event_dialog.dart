                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 8),
                      Text(
                        event.deviationM == null
                            ? 'Distance not recorded'
                            : '${event.deviationM!.toStringAsFixed(1)} m',
                        style: TextStyle(
                          fontSize: event.deviationM == null ? 18 : 30,
                          fontWeight: FontWeight.w600,
                          color: accent,
                        ),
                      ),
                ...
                ExpansionTile(
                  ...
                  children: [
                    ...
                    _EventField(
                      label: 'Operation',
                      value:
                          '${event.intentId} · version ${event.intentVersion}',
                    ),
                    _EventField(
                      label: 'Assignment',
                      value:
                          '${event.assignmentId} · generation ${event.generation}',
                    ),
                    _EventField(
